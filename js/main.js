...
var timerId = setInterval(add_counter, 2900);
//seen eye
...
var deadline = new Date(Date.parse(new Date()) + 3 * 30 * 60 * 60 * 1000); // for endless timer
initializeClock('countdown-l', deadline);
//COUNT-l
...
var deadline = "January 01 2020 00:00:00 GMT+0300"; //for Ukraine
var deadline = new Date(Date.parse(new Date()) + 3 * 28 * 60 * 60 * 1000); // for endless timer
initializeClock('countdown-с', deadline);
//COUNT-c
...
var deadline = "January 01 2020 00:00:00 GMT+0300"; //for Ukraine
var deadline = new Date(Date.parse(new Date()) + 3 * 31 * 60 * 60 * 1000); // for endless timer
initializeClock('countdown-r', deadline);
//COUNT-r
